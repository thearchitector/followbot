...
//    vector<string> goodImageList;
    ...
    for (i = j = 0; i < nimages; i++) {
        cout << "Calib img number " << i << "/" << nimages << endl;
        for (k = 0; k < 2; k++) {
...
//            }
            ...
            Mat img;
            Mat cimg;
            k == 0 ? stream1.read(cimg) : stream2.read(cimg);
            ...
            if (imageSize == Size())
                ...
                cout << "Read images have different sizes";
                exit(-1);
            }
...
//            goodImageList.push_back(imagelist[i * 2 + 1]);
    ...
    double rms = stereoCalibrate(objectPoints, imagePoints[0], imagePoints[1],
                                 ...
                                 CALIB_SAME_FOCAL_LENGTH +  // ok since using the same cameras
