...
//           "M2" << cameraMatrix[1] << "D2" << distCoeffs[1];
        fs << "M1" << cameraMatrix[0] << "D1" << D1 <<
           "M2" << cameraMatrix[1] << "D2" << D2;
        fs.release();
    }
    else
...
//                  CALIB_ZERO_DISPARITY, 1, imageSize, &validRoi[0], &validRoi[1]);
    ...
    cv::fisheye::stereoRectify(K1, D1, K2, D2, imageSize, R, T, R1, R2, P1, P2,
                               Q, CALIB_ZERO_DISPARITY, imageSize, 0.0, 1.0);
...
//    initUndistortRectifyMap(cameraMatrix[1], distCoeffs[1], R2, P2, imageSize, CV_16SC2, rmap[1][0], rmap[1][1]);
    initUndistortRectifyMap(cameraMatrix[0], D1, R1, P1, imageSize, CV_16SC2, rmap[0][0], rmap[0][1]);
    initUndistortRectifyMap(cameraMatrix[1], D2, R2, P2, imageSize, CV_16SC2, rmap[1][0], rmap[1][1]);
